...
const features = [
  {
    ...
    description:
      "Registreer uren, volg werkzaamheden en houd duidelijke rapportages bij voor alle projecten en activiteiten.",
    tag: "Kern"
  },
  {
    icon: "☑",
    title: "Taakbeheer",
    description:
      "Organiseer taken per project, volg de voortgang door verschillende fasen en beheer uw werk vanuit één oogopslag.",
    tag: "Kern"
  },
  {
    icon: "📊",
    title: "Dashboard & Grafieken",
    description:
      "Visuele samenvattingen, projecttijdlijnen en grafieken die laten zien waar tijd daadwerkelijk aan wordt besteed.",
    tag: "Analyses"
  },
  {
    icon: "🔄",
    title: "Odoo Synchronisatie",
    description:
      "Achtergrond-daemon synchroniseert met Odoo-instanties — lokale gegevens en externe systemen blijven in lijn.",
    tag: "Integratie"
  },
  {
    icon: "📱",
    ...
    description:
      "Convergent ontwerp voor telefoons en desktops. Eén codebase, twee vormfactoren.",
    tag: "Platform"
  },
  {
    icon: "🔔",
    ...
    description:
      "Systeemmeldingen voor projectupdates, taakwijzigingen en synchronisatie-gebeurtenissen.",
    tag: "UX"
  }
];
...
const techStack = [
  {
    ...
    tech: "QML",
    description:
      "Applicatie UI, pagina's, gedeelde componenten en de gebruikersinteractielaag.",
    path: "qml/"
  },
  {
    layer: "Logica",
    tech: "JavaScript",
    description:
      "Gedeelde status, datamodellen en feature-overschrijdende hulpmiddelen.",
    path: "models/"
  },
  {
    layer: "Diensten",
    tech: "Python",
    description:
      "Backend-koppeling, daemon-proces, synchronisatieroutines en systeemintegratie.",
    path: "src/"
  }
];
...
const docPaths = [
  {
    audience: "Gebruikers",
    description:
      "Installatie-, installatie-, synchronisatieconfiguratie- en probleemoplossingsgidsen.",
    link: "/docs/user/overview",
    cta: "Gebruikershandleiding",
    pages: ["Overzicht", "Installeren & Uitvoeren", "Configuratie & Synchronisatie", "Functies", "Problemen Oplossen"]
  },
  {
    audience: "Bijdragers",
    description:
      "PR-workflow, lokale ontwikkelingsconfiguratie en documentatiebeheer.",
    link: "/docs/contributing/getting-started",
    cta: "Bijdragersgids",
    pages: ["Aan de slag", "PR-richtlijnen", "Documentatiebeheer"]
  },
  {
    audience: "Onderhouders",
    description:
      "Architectuurbeslissingen, repository-lay-out, buildsysteem en releaseproces.",
    link: "/docs/technical/architecture",
    cta: "Technische documentatie",
    pages: ["Architectuur", "Repository Organisatie", "Bouwen & Verpakken", "Releaseproces"]
  }
];
...
function DeviceSimulator() {
  ...
  const menuItems = [
    ...
    { name: "Urenregistratie", icon: "⏱", target: "Timesheets" },
    { name: "Activiteiten", icon: "📅", target: "Activities" },
    { name: "Mijn taken", icon: "⭐", target: "My Tasks" },
    { name: "Alle taken", icon: "☑", target: "All Tasks" },
    { name: "Projecten", icon: "📁", target: "Projects" },
    { name: "Projectupdates", icon: "🕒", target: "Project Updates" },
    { name: "Over ons", icon: "ℹ", target: "About Us" },
    { name: "Instellingen", icon: "⚙", target: "Settings" }
  ];
  ...
  const renderDashboardMatrix = () => (
    <div className={styles.matrixSection}>
      <div className={styles.matrixTitle}>Tijd besteed op basis van prioriteiten</div>
      
      <div className={styles.matrixWrapper}>
        <div className={styles.matrixHeaderRow}>
          <div style={{ width: "24px" }} />
          <div className={styles.matrixColHeader}>URGENT</div>
          <div className={styles.matrixColHeader}>NIET URGENT</div>
        </div>
        ...
        <div className={styles.matrixBodyRow}>
          ...
          <div className={clsx(styles.matrixCard, styles.matrixCardUrgentImportant)}>
            ...
            <div className={styles.matrixCardLabel}>Eerst doen</div>
          ...
          <div className={clsx(styles.matrixCard, styles.matrixCardNoturgentImportant)}>
            <div className={styles.matrixCardIcon}>🕒</div>
            <div className={styles.matrixCardLabel}>Daarna doen</div>
        ...
        <div className={styles.matrixBodyRow}>
          ...
          <div className={clsx(styles.matrixCard, styles.matrixCardUrgentNotimportant)}>
            <div className={styles.matrixCardIcon}>⏱</div>
            <div className={styles.matrixCardLabel}>Later doen</div>
            <div className={styles.matrixCardValue}>0H</div>
          </div>

          <div className={clsx(styles.matrixCard, styles.matrixCardNoturgentNotimportant)}>
            <div className={styles.matrixCardIcon}>🗑</div>
            <div className={styles.matrixCardLabel}>Niet doen</div>
  ...
  const renderProjectOverview = () => (
    <>
      ...
      <div className={styles.chartHeading}>Meest Tijdrovende Projecten</div>
  ...
  const renderTimesheetEntryForm = () => (
    <div className={styles.formContainerActual}>
      ...
      <div className={styles.formRowInput}>
        ...
        <span className={styles.formValueMain} style={{ fontWeight: 400, color: "#888" }}>Tik om te selecteren</span>
      </div>
      ...
      <div className={styles.priorityRadioGrid}>
        <div className={styles.radioOption}>
          ...
          <span>Belangrijk, Urgent (1)</span>
        </div>
        <div className={styles.radioOption}>
          <div className={styles.radioCircle} />
          <span>Belangrijk, Niet Urgent (2)</span>
        </div>
        <div className={styles.radioOption}>
          <div className={styles.radioCircle} />
          <span>Urgent, Niet Belangrijk (3)</span>
        </div>
        <div className={styles.radioOption}>
          <div className={styles.radioCircle} />
          <span>Niet Urgent, Niet Belangrijk (4)</span>
        </div>
      </div>
...
export default function Home() {
  ...
  return (
    <Layout
      title="Product- & Documentatiehub"
      description="TimeManagement — een praktische tijd-, taak- en synchronisatiewerkruimte voor Ubuntu Touch en desktop. Open source, drielagige architectuur, community-gedreven."
    >
      {/* ── HERO ── */}
      <header className={styles.hero}>
        ...
        <div className="container">
          ...
          <p className={styles.heroTagline}>
            Een praktische werkruimte voor het bijhouden van tijd, het beheren van taken en het
            synchroniseren met Odoo — gebouwd voor Ubuntu Touch en desktop.
          </p>
      ...
      <main ref={mainRef}>
        ...
        <section className={clsx(styles.section, styles.sectionLight)}>
          <div className="container">
            <div data-reveal>
              <p className={styles.sectionLabel}>Mogelijkheden</p>
              <h2
                className={clsx(styles.sectionTitle, styles.sectionTitleLight)}
              >
                Alles wat u nodig heeft om werk bij te houden en georganiseerd te blijven
              </h2>
            </div>
        ...
        <section className={clsx(styles.section, styles.sectionDark)}>
          <div className="container">
            <div data-reveal>
              <p className={styles.sectionLabel}>Architectuur</p>
              <h2
                className={clsx(styles.sectionTitle, styles.sectionTitleDark)}
              >
                Drie lagen, één samenhangend systeem
              </h2>
            </div>
        ...
        <section className={clsx(styles.section, styles.sectionLight)}>
          <div className="container">
            <div data-reveal>
              <p className={styles.sectionLabel}>Documentatie</p>
              <h2
                className={clsx(styles.sectionTitle, styles.sectionTitleLight)}
              >
                Begin bij de route die bij uw rol past
              </h2>
            </div>
        ...
        <section className={clsx(styles.section, styles.sectionDark)}>
          <div className="container">
            <div className={styles.ossCta} data-reveal>
              <h2>Openbaar gebouwd</h2>
              <p>
                TimeManagement is open source. Blader door de code, rapporteer problemen of lever direct een bijdrage op GitHub.
              </p>
