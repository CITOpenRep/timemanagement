...
*   **Standaardwaarden:** Datum is standaard ingesteld op Vandaag.
...
*   Veeg naar rechts om toe te voegen aan Favorieten.
*   Filter projecten op basis van hun respectievelijke fasen in Odoo (Kanban-toewijzing).
*   Filter de projectlijst om de fase 'Gereed' uit te sluiten.
...
### Functies
*   Bekijk subtaken met hiërarchie voor uit-/samenvouwen.
*   Zoekknop.
...
*   Taakkleur overgenomen van het bovenliggende project.
...
*   **Tweevoudig fasesysteem:**
    ...
    *   *Persoonlijke fasen ("Mijn taken"):* Aangepaste, gebruikersspecifieke fasen om de persoonlijke werkvoortgang onafhankelijk te organiseren.
*   **Prioriteitssterren:** Taken met hoge prioriteit tonen visuele sterbadges (0 tot 3 niveaus) toegewezen aan het Odoo-prioriteitschema.
...
*   Taaknaam, Fase, Instantie, Project, Subproject, Bovenliggende taak, Deadline, Toegewezen persoon, Favoriet, Uren, Datums (begin en einde), Aantal subtaken, Details link.
