...
### Paneel Taakdetails
Om een ​​nieuwe taak aan te maken, klikt u op het pictogram `+` om het nieuwe taakinvoerformulier te openen.
Om de taakdetails van een reeds aangemaakte taak te bekijken, klikt u op de overeenkomstige taak om gedetailleerde informatie weer te geven.
...
### Veeg naar links Acties (bekijken, bewerken, starten en pauzeren)
