...
- filiaal van `main`
- gebruik filiaalnamen zoals `feature/add-timesheet-export`
...
- update relevante documenten bij het toevoegen of wijzigen van functionaliteit
- voeg alleen inline-opmerkingen toe als de code niet voor de hand ligt
- update naamgeving of architectuurcontracten indien van toepassing

## PR-beschrijving

Elke PR moet het volgende omvatten:
