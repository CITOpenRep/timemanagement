...
De Docusaurus-site wordt het belangrijkste openbare documentatieoppervlak voor het project.
...
- update bijdragende documenten wanneer de workflow of beoordelingsverwachtingen veranderen
...
- de root `README.md` blijft kort en verwijst naar de site
