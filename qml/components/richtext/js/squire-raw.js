...
(function (doc, undefined) {
    ...
    */
    ...
    proto._updatePath = function (range, force) {
        ...
        if (force || anchor !== this._lastAnchorNode ||
            ...
            if (this._path !== newPath) {
                ...
                //            oxide.sendMessage('pathChanged', { path: newPath });
            }
        }
    ...
    proto.makeLinkWithText = function (url, text, attributes) {
        var range = this.getSelection();
        // Insert the display text at cursor position
        insertNodeInRange(
            range,
...
oxide.addMessageHandler("focus", function (msg) { window.editor.focus(); });
oxide.addMessageHandler("blur", function (msg) { window.editor.blur(); });
oxide.addMessageHandler("bold", function (msg) {
    console.log("[Squire] bold handler called");
    var e = window.editor;
    if (e.hasFormat("B") || e.hasFormat("STRONG")) {
        console.log("[Squire] Removing bold");
        e.removeBold();
    } else {
        console.log("[Squire] Adding bold");
        e.bold();
    }
});
oxide.addMessageHandler("bold_DISABLED", function (msg) {
    var e = window.editor;
    if (!e.hasFormat('B')) {
        window.editor.bold();
    }
});
oxide.addMessageHandler("removeBold", function (msg) {
    var e = window.editor;
    if (e.hasFormat('B')) {
        window.editor.removeBold();
    }
});
oxide.addMessageHandler("italic", function (msg) {
    var e = window.editor;
    if (!e.hasFormat('I')) {
        window.editor.italic();
    }
});
oxide.addMessageHandler("removeItalic", function (msg) {
    var e = window.editor;
    if (e.hasFormat('I')) {
        window.editor.removeItalic();
    }
});
oxide.addMessageHandler("underline", function (msg) {
    var e = window.editor;
    if (!e.hasFormat('U')) {
        window.editor.underline();
    }
});
oxide.addMessageHandler("removeUnderline", function (msg) {
    var e = window.editor;
    if (e.hasFormat('U')) {
        window.editor.removeUnderline();
    }
});
oxide.addMessageHandler("strikethrough", function (msg) { window.editor.strikethrough(); });
oxide.addMessageHandler("removeStrikethrough", function (msg) { window.editor.removeStrikethrough(); });
oxide.addMessageHandler("subscript", function (msg) { window.editor.subscript(); });
oxide.addMessageHandler("removeSubscript", function (msg) { window.editor.removeSubscript(); });
oxide.addMessageHandler("superscript", function (msg) { window.editor.superscript(); });
oxide.addMessageHandler("removeSuperscript", function (msg) { window.editor.removeSuperscript(); });
oxide.addMessageHandler("hasFormat", function (msg) { msg.reply({ 'prop': msg.payload, 'value': window.editor.hasFormat(msg.payload) }); });
oxide.addMessageHandler("undo", function (msg) { window.editor.undo(); });
oxide.addMessageHandler("redo", function (msg) { window.editor.redo(); });
oxide.addMessageHandler("getHTML", function (msg) { msg.reply(window.editor.getHTML()); });
oxide.addMessageHandler("setHTML", function (msg) { window.editor.setHTML(msg.payload); });
oxide.addMessageHandler("getCursorPosition", function (msg) { msg.reply(window.editor.getCursorPosition()); });
oxide.addMessageHandler('makeLink', function (msg) { window.editor.makeLink(msg.payload.url, msg.payload.attrs); });
oxide.addMessageHandler('makeLinkWithText', function (msg) { window.editor.makeLinkWithText(msg.payload.url, msg.payload.text, msg.payload.attrs); });
oxide.addMessageHandler('setTextAlignment', function (msg) { window.editor.setTextAlignment(msg.payload); });
oxide.addMessageHandler('setTextDirection', function (msg) { window.editor.setTextDirection(msg.payload); });
oxide.addMessageHandler('increaseQuoteLevel', function (msg) { window.editor.increaseQuoteLevel(); });
oxide.addMessageHandler('decreaseQuoteLevel', function (msg) { window.editor.decreaseQuoteLevel(); });
oxide.addMessageHandler('makeUnorderedList', function (msg) { window.editor.makeUnorderedList(); });
oxide.addMessageHandler('makeOrderedList', function (msg) { window.editor.makeOrderedList(); });
oxide.addMessageHandler('removeList', function (msg) { window.editor.removeList(); });
oxide.addMessageHandler('increaseListLevel', function (msg) { window.editor.increaseListLevel(); });
oxide.addMessageHandler('decreaseListLevel', function (msg) { window.editor.decreaseListLevel(); });
oxide.addMessageHandler('removeAllFormatting', function (msg) { window.editor.removeAllFormatting(); });
oxide.addMessageHandler('setFontSize', function (msg) { window.editor.setFontSize(msg.payload); });
oxide.addMessageHandler('setTextColour', function (msg) { window.editor.setTextColour(msg.payload); });
oxide.addMessageHandler('setHighlightColour', function (msg) { window.editor.setHighlightColour(msg.payload); });
