...
Item {
    ...
    // Use a Dialog opened via PopupUtils so positioning matches other popups (NotificationPopup.qml)
    Component {
        id: dialogComponent
        ...
        Dialog {
            id: popupDialog
            title: "Notifications"
            // Size similar to previous popup
            ...
            // Optional styling (dark/light handled by Lomiri themes)
            ColumnLayout {
                anchors.fill: parent
