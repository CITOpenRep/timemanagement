                                                            ...
                                                            property bool showSearchBox: true
                                                                property string currentFilter: ""  // Track currently selected filter
                                                                    ...
                                                                    function buildFilterModelFromLegacyProperties()
                                                                    {
                                                                        ...
                                                                        if (label1 !== "" && filter1 !== "")
                                                                        {
                                                                            newModel.push({label: label1, filterKey: filter1});
                                                                        }
                                                                        if (label2 !== "" && filter2 !== "")
                                                                        {
                                                                            newModel.push({label: label2, filterKey: filter2});
                                                                        }
                                                                        if (label3 !== "" && filter3 !== "")
                                                                        {
                                                                            newModel.push({label: label3, filterKey: filter3});
                                                                        }
                                                                        if (label4 !== "" && filter4 !== "")
                                                                        {
                                                                            newModel.push({label: label4, filterKey: filter4});
                                                                        }
                                                                        if (label5 !== "" && filter5 !== "")
                                                                        {
                                                                            newModel.push({label: label5, filterKey: filter5});
                                                                        }
                                                                        if (label6 !== "" && filter6 !== "")
                                                                        {
                                                                            newModel.push({label: label6, filterKey: filter6});
                                                                        }
                                                                        if (label7 !== "" && filter7 !== "")
                                                                        {
                                                                            newModel.push({label: label7, filterKey: filter7});
                                                                        }
